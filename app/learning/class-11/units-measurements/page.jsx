...
export default function UnitsPage() {
  ...
  const theoremData = {
    ...
    description: 'Fundamental units, dimensional analysis, and error measurement in physics',
    difficulty: 'Easy',
    points: 120,
    duration: '25 min',
    class: 11,
    subject: 'physics',
    concept: 'Units provide a standard for measurement. Dimensional analysis helps verify equations and convert units.',
    learningObjectives: [
      'Understand fundamental and derived units in SI system',
      'Perform dimensional analysis of physical quantities',
      'Calculate significant figures and experimental errors',
      'Convert between different unit systems',
      'Apply units in solving physics problems'
    ],
    theory: {
      introduction: "Units and measurements form the foundation of all physics. Every physical quantity must be expressed with appropriate units to have meaning.",
      keyPoints: [
        {
          title: "Fundamental Units",
          description: "Seven base units in SI system that define all other units",
          example: "Length (m), Mass (kg), Time (s), Current (A), Temperature (K), Amount (mol), Luminous intensity (cd)"
        },
        {
          title: "Derived Units",
          description: "Units formed by combining fundamental units",
          example: "Velocity = m/s, Force = kg⋅m/s², Energy = kg⋅m²/s²"
        },
        {
          title: "Dimensional Formula",
          description: "Expression showing powers of fundamental dimensions",
          example: "Force: [M¹L¹T⁻²], Energy: [M¹L²T⁻²]"
        },
        {
          title: "Significant Figures",
          description: "Digits that carry meaningful information about precision",
          example: "123.45 has 5 significant figures, 0.00234 has 3 significant figures"
        },
        {
          title: "Error Analysis",
          description: "Absolute error = |measured - true|, Relative error = (absolute error/true value) × 100%",
          example: "If true = 10.0, measured = 9.8, then absolute error = 0.2, relative error = 2%"
        }
      ]
    },
    examples: [
      {
        ...
        solution: "Dimensionally correct",
        explanation: "[v²] = [L²T⁻²], [u²] = [L²T⁻²], [2as] = [LT⁻²][L] = [L²T⁻²]. All terms have same dimension [L²T⁻²]."
      },
      {
        title: "Unit Conversion",
        problem: "Convert 72 km/h to m/s.",
        solution: "20 m/s",
        explanation: "72 km/h = 72 × (1000 m)/(3600 s) = 72000/3600 = 20 m/s"
      },
      {
        title: "Significant Figures",
        problem: "Add 12.11 + 18.0 + 1.013 with correct significant figures.",
        solution: "31.1",
        explanation: "Sum = 31.123. Since 18.0 has 1 decimal place (least), answer = 31.1"
      },
      {
        title: "Error Calculation",
        problem: "If measured length = 2.54 cm and true length = 2.50 cm, find percentage error.",
        solution: "1.6%",
        explanation: "Absolute error = |2.54 - 2.50| = 0.04 cm. Percentage error = (0.04/2.50) × 100% = 1.6%"
      }
    ],
    practiceProblems: [
      {
        ...
        correct: 1,
        explanation: "Force = mass × acceleration. SI unit = kg × m/s² = kg⋅m/s² (Newton)"
      },
      {
        id: 2,
        ...
        options: ["2", "3", "4", "5"],
        correct: 1,
        explanation: "Leading zeros don't count. Trailing zero after decimal and nonzero digits counts. So: 4, 5, 0 = 3 significant figures"
      },
      {
        id: 3,
      ...
      {
        id: 4,
        question: "Convert 1 year to seconds (approximately).",
        options: ["3.15 × 10⁶ s", "3.15 × 10⁷ s", "3.15 × 10⁸ s", "3.15 × 10⁹ s"],
        correct: 1,
        explanation: "1 year ≈ 365 days × 24 hours × 3600 seconds = 31,536,000 s ≈ 3.15 × 10⁷ s"
      }
    ],
    realWorldApplications: [
      "GPS systems: precise time and distance measurements",
      "Medical equipment: accurate dosage calculations",
      "Engineering: structural analysis and safety factors",
      "Space missions: navigation and trajectory calculations",
      "Manufacturing: quality control and precision standards"
    ],
    tips: [
      "Always write units with numerical values",
      "Use dimensional analysis to check equation correctness",
      "Round final answers to appropriate significant figures",
      "Learn prefixes: k(10³), M(10⁶), G(10⁹), m(10⁻³), μ(10⁻⁶), n(10⁻⁹)",
      "Practice unit conversions daily to build fluency"
    ]
  };
